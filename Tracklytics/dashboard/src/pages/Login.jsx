...
const Login = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // For login, we only have email immediately. In a real app backend gives Name.
        // We'll mock the name from the email for the front-end feel.
        const mockName = email.split('@')[0];
        login({ name: mockName, email });
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <div className="flex justify-center flex-col items-center">
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Sign in to your Tracklytics account
                    </p>
                </div>
            </div>
